...
/****************************************************************
 * The author of this software is David M. Gay. Copyright (c) 1991, 2000, 2001
 * by Lucent Technologies. Permission to use, copy, modify, and distribute this
				...
				else if( j < 0 || ( j == 0 && ( ( word1 & 1 ) == 0 ) ) )
				{
					if( j1 > 0 )
					{
						...
						if( j1 > 0 ) /*
										 ...
										 * & 1))) is not here because it messes
										 * up odd base output such as 3.5 in
										 * base 3.
										 */
							digit++;
					}
