 ...
 * @author Tal Liron
 */
public class NashornJsonImplementationOld implements JsonImplementationOld
{
	//
	// Construction
	//

	public NashornJsonImplementationOld()
	{
		this( null );
	}

	public NashornJsonImplementationOld( NashornJsonExtenderOld jsonExtender )
	{
	...
	private final NashornJsonExtenderOld jsonExtender;
